...
# only. Still ready for B.
# Exit € size clash keep fees vs drag gap dir sides share vs Δ align size
# (`closes_exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_size`):
# both signed magnitudes when align already spoke (portfolio AI count ≠ € +
# xang1234 speak-both-sides). Align names wide or thin. Size puts the ×
# spread and the pp spread on one line so friends can audit the match.
# Clash stays silent. Near-zero stays silent. worse warns only. Still
# ready for B.
# Exit € size clash keep fees vs drag gap dir sides share vs Δ align lead
# (`closes_exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_lead`):
# which spread is louder vs its own wide floor when size already spoke
# (portfolio AI count ≠ € + xang1234 severity). × loudness is |Δ|÷0.5.
# % loudness is |Δpp|÷20. Speak only when one is ≥2× the other. Near-equal
# stays silent (size already shows both). Clash stays silent. worse warns
# only. Still ready for B.
# Exit € size clash keep fees vs drag gap dir sides share vs Δ align lead size
# (`closes_exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_lead_size`):
# louder floor-units ÷ quieter floor-units when lead already spoke
# (portfolio AI count ≠ € + xang1234 severity). Lead names × or %. Size
# is the margin so friends do not reverse-divide. Speak only when the
# margin is ≥2×. Near-equal stays silent. Clash stays silent. worse
# warns only. Still ready for B.
# Exit € size clash keep fees vs drag gap dir sides share vs Δ align lead size sides
# (`closes_exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_lead_size_sides`):
# louder and quieter floor-units when lead size already spoke (portfolio AI
# count ≠ € + xang1234 speak-both-sides). Size is the margin. Sides name
# both loudnesses so friends can audit without reverse-dividing. Clash
# stays silent. worse warns only. Still ready for B.
# Exit € size clash keep fees vs drag gap dir sides share vs Δ align lead size sides Δ
# (`closes_exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_lead_size_sides_delta`):
# additive louder − quieter floor-units when sides already spoke (portfolio AI
# count ≠ € + xang1234 severity after speak-both-sides). Size is the margin;
# sides name both; Δ is the additive spread so a huge ratio on tiny
# floor-units does not look like a huge gap. wide |Δ| ≥ FEES_THIN (0.5×);
# thin |Δ| < FEES_COMFORTABLE (0.25×); mid silent. Clash stays silent.
# worse warns only. Still ready for B.
# Exit € size clash keep fees vs drag gap dir sides share vs Δ align lead size sides share
# (`closes_exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_lead_size_sides_share`):
# louder% and quieter% of (louder + quieter) when sides already spoke
# (portfolio AI + xang1234 €-conc share after absolute sides / Δ). Absolute
# floor-units and additive Δ ≠ ownership of the loudness story. worse warns
# only. Still ready for B.
# Exit € size clash keep fees vs drag gap dir sides share vs Δ align lead size sides share Δ
# (`closes_exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_lead_size_sides_share_delta`):
# louder% − quieter% when share already spoke (portfolio AI + xang1234).
# Share names both %; Δ is the pp spread so near-even ownership stays quiet
# while a lopsided pair speaks. wide |Δ| ≥ EXIT_CONC_SKEW_PP (20). thin
# |Δ| < half that (10). Mid silent. Near-zero silent. worse warns only.
# Still ready for B.
# Exit € size clash keep fees vs drag gap dir sides share vs Δ align lead size sides share vs Δ
# (`closes_exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_lead_size_sides_share_vs_delta`):
# speak when louder−quieter floor-unit Δ and ownership Δ disagree (portfolio AI
# count ≠ € + xang1234 severity). Same lean stays silent. Both mid stay silent.
# worse warns only. Still ready for B.
# Exit € size clash keep fees vs drag gap dir sides share vs Δ align lead size sides share vs Δ align
# (`closes_exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_lead_size_sides_share_vs_delta_align`):
# speak when louder−quieter floor-unit Δ and ownership Δ agree (portfolio AI +
...
# Exit € size clash keep fees vs drag gap dir sides share vs Δ align lead size sides share vs Δ align lead size
...
# louder÷quieter floor-units when nested lead already spoke (portfolio AI count
# ≠ € + xang1234 severity). Lead names × or %. Size is the margin. Speak only
# when margin ≥2×. Near-equal stays silent. Clash stays silent. worse warns
# only. Still ready for B.
# Exit € size clash keep fees vs drag gap dir sides share vs Δ align lead size sides share vs Δ align lead size sides
# (`closes_exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_lead_size_sides_share_vs_delta_align_lead_size_sides`):
# louder and quieter floor-units when nested lead size already spoke (portfolio
# AI count ≠ € + xang1234 speak-both-sides). Nested size is the margin.
# Sides name both loudnesses so friends can audit without reverse-dividing.
# Clash stays silent. worse warns only. Still ready for B.
# Exit € size clash keep fees vs drag gap dir sides share vs Δ align lead size sides share vs Δ align lead size sides Δ
...
# additive louder − quieter floor-units when nested sides already spoke
# (portfolio AI count ≠ € + xang1234 severity after speak-both-sides). Nested
# size is the margin; nested sides name both floor-units; Δ is the additive
# spread so a huge ratio on tiny floor-units does not look like a huge gap.
# wide |Δ| ≥ WINDOW_A_FEES_THIN_RATIO. thin |Δ| < WINDOW_A_FEES_COMFORTABLE_RATIO.
# Mid silent. Near-zero silent. Clash stays silent. worse warns only. Still
# ready for B.
# Exit € size clash keep fees vs drag gap dir sides share vs Δ align lead size sides share vs Δ align lead size sides share
# (`closes_exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_lead_size_sides_share_vs_delta_align_lead_size_sides_share`):
# louder% and quieter% of (louder + quieter) when nested sides already spoke
# (portfolio AI + xang1234 €-conc share after absolute nested sides / Δ). Absolute
# floor-units and additive Δ ≠ ownership of the loudness story. worse warns
# only. Still ready for B.
# Exit € size clash keep fees vs drag gap dir sides share vs Δ align lead size sides share vs Δ align lead size sides share Δ
...
# louder% − quieter% when nested share already spoke (portfolio AI + xang1234).
# Nested share names both %; Δ is the pp spread so near-even ownership stays
# quiet while a lopsided pair speaks. wide |Δ| ≥ EXIT_CONC_SKEW_PP (20). thin
# |Δ| < half that (10). Mid silent. Near-zero silent. worse warns only.
# Still ready for B.
# Exit € size clash keep fees vs drag gap dir sides share vs Δ align lead size sides share vs Δ align lead size sides share vs Δ
...
# speak when nested louder−quieter floor-unit Δ and nested ownership Δ disagree
# (portfolio AI count ≠ € + xang1234 severity). Same lean stays silent. Both mid
# stay silent. worse warns only. Still ready for B.
# Exit € size clash keep fees vs drag gap dir sides share vs Δ align lead size sides share vs Δ align lead size sides share vs Δ align
...
# speak when nested louder−quieter floor-unit Δ and nested ownership Δ agree
# (portfolio AI + xang1234 speak-both-sides confirm). Clash covers mid-vs-spoke.
# Align covers both wide or both thin. Different lean stays silent. One mid
# stays on clash. worse warns only. Still ready for B.
...
def _exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_size(
    align: str,
    vs: str,
    sides_delta: float | None,
    share_delta: float | None,
) -> tuple[str, str, bool]:
    """Speak both signed magnitudes when × Δ and share Δ already align.

    Align names the matching lean. Size puts the additive × spread and
    the pp spread on one line so friends can audit the confirm without
    hunting the earlier Δ bits (portfolio AI count ≠ € + xang1234
    speak-both-sides). Speak only when align already spoke and both
    deltas are known. Near-zero stays silent. ``worse`` warns only.
    Still ready for B.
    """
    if align != "align":
        return "", "", False
    ...
    if sides_delta is None or share_delta is None:
        return "", "", False
    x_delta = float(sides_delta)
    p_delta = float(share_delta)
    if abs(x_delta) < 1e-9 or abs(p_delta) < 1e-9:
        return "", "", False
    bit = (
        "A exits € size clash keep fees vs drag gap dir sides share vs Δ "
        f"align size · {_fmt_fee_keep_signed(x_delta)} · "
        f"{_fmt_share_pp_signed(p_delta)}"
    )
    return "size", bit, vs == "worse"


def _exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_lead(
    size: str,
    vs: str,
    sides_delta: float | None,
    share_delta: float | None,
) -> tuple[str, str, bool]:
    """Name the louder spread when align size already spoke.

    Size shows both signed magnitudes. Lead says which one is further
    past its own wide floor (× vs ``WINDOW_A_FEES_THIN_RATIO``, % vs
    ``WINDOW_A_EXIT_CONC_SKEW_PP``). Speak only when one loudness is
...
def _exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_lead_size(
    lead: str,
    vs: str,
    sides_delta: float | None,
    share_delta: float | None,
) -> tuple[str, float | None, str, bool]:
    """How many times louder the align lead is versus the quieter spread.

    Lead names × or %. Size puts louder÷quieter floor-units on one line
    so friends do not reverse-divide (portfolio AI count ≠ € + xang1234
    severity). Speak only when lead already spoke and the margin is
    ≥ ``WINDOW_A_PROFIT_FACTOR_STRONG_RATIO``. Near-equal stays silent.
    Clash stays silent. ``worse`` warns only. Still ready for B.
    """
    if lead not in ("×", "%"):
        return "", None, "", False
    ...
    bit = (
        "A exits € size clash keep fees vs drag gap dir sides share vs Δ "
        f"align lead size · {_fmt_fee_keep(shown)}"
    )
    return "size", shown, bit, vs == "worse"


def _exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_lead_size_sides(
    lead_size: str,
    lead: str,
    vs: str,
    sides_delta: float | None,
    ...
    """Louder and quieter floor-units when align lead size already spoke.

    Lead size is the margin (louder÷quieter). Sides name both floor-unit
    loudnesses so friends can audit without reverse-dividing (portfolio AI
    count ≠ € + xang1234 speak-both-sides). Speak only when lead size
    already spoke. Clash stays silent. ``worse`` warns only. Still ready
    for B.
    """
    if lead_size != "size":
        return None, None, "", False
    ...
    if lead == "×":
        if x_loud < p_loud:
            return None, None, "", False
        louder, quieter = x_loud, p_loud
    else:
        if p_loud < x_loud:
            return None, None, "", False
        louder, quieter = p_loud, x_loud
    louder_r = round(louder, 2)
    quieter_r = round(quieter, 2)
    bit = (
        "A exits € size clash keep fees vs drag gap dir sides share vs Δ "
        f"align lead size sides · louder {_fmt_fee_keep(louder)} · quieter "
        f"{_fmt_fee_keep(quieter)}"
    )
    return louder_r, quieter_r, bit, vs == "worse"


def _exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_lead_size_sides_delta(
    sides_bit: str,
    vs: str,
    louder: float | None,
    quieter: float | None,
) -> tuple[str, float | None, str, bool]:
    """Additive louder − quieter floor-units when align lead size sides spoke.

    Lead size is the margin (louder÷quieter). Sides name both floor-units.
    Δ speaks the additive spread so a huge ratio on tiny floor-units does
    not look like a huge gap (portfolio AI count ≠ € + xang1234 severity
    after speak-both-sides). Speak only when sides already spoke and both
    loudnesses are known. wide |Δ| ≥ ``WINDOW_A_FEES_THIN_RATIO``. thin
    |Δ| < ``WINDOW_A_FEES_COMFORTABLE_RATIO``. Mid stays silent. Near-zero
    stays silent. Clash stays silent. ``worse`` warns only. Still ready
    for B.
    """
    if not (sides_bit or "").strip():
    ...
    if vs not in ("worse", "better"):
        return "", None, "", False
    if louder is None or quieter is None:
        return "", None, "", False
    delta = float(louder) - float(quieter)
    if abs(delta) < 1e-9:
        return "", None, "", False
    mag = abs(delta)
    if mag >= WINDOW_A_FEES_THIN_RATIO:
    ...
    bit = (
        "A exits € size clash keep fees vs drag gap dir sides share vs Δ "
        f"align lead size sides Δ {lean} · {_fmt_fee_keep_signed(delta)}"
    )
    return lean, rounded, bit, vs == "worse"


def _exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_lead_size_sides_share(
    sides_bit: str,
    vs: str,
    louder: float | None,
    quieter: float | None,
) -> tuple[float | None, float | None, str, bool]:
    """Louder% and quieter% of floor-unit sum when align lead size sides spoke.

    Sides speak absolute floor-units. Δ speaks additive spread. Share speaks
    ownership of that loudness pair (portfolio AI + xang1234 €-conc after
    absolute). Speak only when sides already spoke and both loudnesses are
    > 0. ``worse`` warns only. Still ready for B.
    """
    if not (sides_bit or "").strip():
        return None, None, "", False
    if vs not in ("worse", "better"):
    ...
    loud = float(louder)
    quiet = float(quieter)
    if loud <= 0 or quiet <= 0:
        return None, None, "", False
    total = loud + quiet
    if total < 1e-9:
        return None, None, "", False
    loud_pct = round(100.0 * loud / total, 1)
    quiet_pct = round(100.0 - loud_pct, 1)
    bit = (
        "A exits € size clash keep fees vs drag gap dir sides share vs Δ "
        f"align lead size sides share · louder {_fmt_share_pct(loud_pct)} · "
        f"quieter {_fmt_share_pct(quiet_pct)}"
    )
    return loud_pct, quiet_pct, bit, vs == "worse"


def _exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_lead_size_sides_share_delta(
    share_bit: str,
    vs: str,
    louder_pct: float | None,
    quieter_pct: float | None,
) -> tuple[str, float | None, str, bool]:
    """Additive louder% − quieter% when align lead size sides share spoke.

    Share speaks ownership %. Δ speaks the pp spread so near-even ownership
    stays quiet while a lopsided pair speaks (portfolio AI + xang1234 after
    share). Speak only when share already spoke and both % known. wide |Δ|
    ≥ ``WINDOW_A_EXIT_CONC_SKEW_PP``. thin |Δ| < ``WINDOW_A_SHARE_DELTA_THIN_PP``.
    Mid stays silent. Near-zero stays silent. ``worse`` warns only. Still
    ready for B.
    """
    if not (share_bit or "").strip():
        return "", None, "", False
    if vs not in ("worse", "better"):
        return "", None, "", False
    if louder_pct is None or quieter_pct is None:
        return "", None, "", False
    delta = float(louder_pct) - float(quieter_pct)
    if abs(delta) < 1e-9:
        return "", None, "", False
    mag = abs(delta)
    if mag >= WINDOW_A_EXIT_CONC_SKEW_PP:
    ...
    bit = (
        "A exits € size clash keep fees vs drag gap dir sides share vs Δ "
        f"align lead size sides share Δ {lean} · {_fmt_share_pp_signed(delta)}"
    )
    return lean, rounded, bit, vs == "worse"


def _exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_lead_size_sides_share_vs_delta(
    sides_delta: str,
    share_delta: str,
    vs: str,
) -> tuple[str, str, bool]:
    """Speak when louder−quieter floor-unit Δ and ownership Δ disagree.

    Speak only when exactly one lean is wide or thin and the other is mid.
    Same lean stays silent. Both mid stay silent. ``worse`` warns only.
    Still ready for B.
    """
    if vs not in ("worse", "better"):
        return "", "", False
    ...
    bit = (
        "A exits € size clash keep fees vs drag gap dir sides share vs Δ "
        "align lead size sides share vs Δ "
        f"clash · × {x_label} · % {s_label}"
    )
    return "clash", bit, vs == "worse"


def _exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_lead_size_sides_share_vs_delta_align(
    sides_delta: str,
    share_delta: str,
    vs: str,
) -> tuple[str, str, bool]:
    """Speak when louder−quieter floor-unit Δ and ownership Δ agree.
...
def _exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_lead_size_sides_share_vs_delta_align_size(
    align: str,
    vs: str,
    sides_delta: float | None,
    share_delta: float | None,
) -> tuple[str, str, bool]:
    """Speak both signed magnitudes when nested align already spoke."""
    if align != "align":
        return "", "", False
    if vs not in ("worse", "better"):
        return "", "", False
    ...
    bit = (
        ...
        f"{_fmt_fee_keep_signed(x_delta)} · {_fmt_share_pp_signed(p_delta)}"
    )
    return "size", bit, vs == "worse"
...
def _exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_lead_size_sides_share_vs_delta_align_lead_size(
    lead: str,
    vs: str,
    sides_delta: float | None,
    share_delta: float | None,
) -> tuple[str, float | None, str, bool]:
    """How many times louder the nested align lead is versus the quieter spread.

    Nested lead names × or %. Size puts louder÷quieter floor-units on one
    line so friends do not reverse-divide (portfolio AI count ≠ € + xang1234
    severity). Speak only when lead already spoke and the margin is
    ≥ ``WINDOW_A_PROFIT_FACTOR_STRONG_RATIO``. Near-equal stays silent.
    Clash stays silent. ``worse`` warns only. Still ready for B.
    """
    ...
    bit = (
        "A exits € size clash keep fees vs drag gap dir sides share vs Δ "
        "align lead size sides share vs Δ align lead size · "
        f"{_fmt_fee_keep(shown)}"
    )
    return "size", shown, bit, vs == "worse"


def _exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_lead_size_sides_share_vs_delta_align_lead_size_sides(
    lead_size: str,
    lead: str,
    vs: str,
    sides_delta: float | None,
    ...
    """Louder and quieter floor-units when nested align lead size already spoke.

    Nested lead size is the margin (louder÷quieter). Sides name both
    floor-unit loudnesses so friends can audit without reverse-dividing
    (portfolio AI count ≠ € + xang1234 speak-both-sides). Speak only when
    nested lead size already spoke. Clash stays silent. ``worse`` warns
    only. Still ready for B.
    """
    if lead_size != "size":
        return None, None, "", False
    ...
    bit = (
        "A exits € size clash keep fees vs drag gap dir sides share vs Δ "
        "align lead size sides share vs Δ align lead size sides · louder "
        f"{_fmt_fee_keep(louder)} · quieter {_fmt_fee_keep(quieter)}"
    )
    return louder_r, quieter_r, bit, vs == "worse"


def _exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_lead_size_sides_share_vs_delta_align_lead_size_sides_delta(
    sides_bit: str,
    vs: str,
    louder: float | None,
    quieter: float | None,
) -> tuple[str, float | None, str, bool]:
    """Additive louder − quieter floor-units when nested align lead size sides spoke.

    Nested lead size is the margin (louder÷quieter). Nested sides name both
    floor-units. Δ speaks the additive spread so a huge ratio on tiny
    floor-units does not look like a huge gap (portfolio AI count ≠ € +
    xang1234 severity after speak-both-sides). Speak only when nested sides
    already spoke and both loudnesses are known. wide |Δ| ≥
    ``WINDOW_A_FEES_THIN_RATIO``. thin |Δ| < ``WINDOW_A_FEES_COMFORTABLE_RATIO``.
    Mid stays silent. Near-zero stays silent. Clash stays silent. ``worse``
    warns only. Still ready for B.
    """
    if not (sides_bit or "").strip():
        return "", None, "", False
    ...
    bit = (
        "A exits € size clash keep fees vs drag gap dir sides share vs Δ "
        "align lead size sides share vs Δ align lead size sides Δ "
        f"{lean} · {_fmt_fee_keep_signed(delta)}"
    )
    return lean, rounded, bit, vs == "worse"


def _exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_lead_size_sides_share_vs_delta_align_lead_size_sides_share(
    sides_bit: str,
    vs: str,
    louder: float | None,
    quieter: float | None,
) -> tuple[float | None, float | None, str, bool]:
    """Louder% and quieter% of floor-unit sum when nested align lead size sides spoke.

    Nested sides speak absolute floor-units. Nested Δ speaks additive spread.
    Share speaks ownership of that loudness pair (portfolio AI + xang1234
    €-conc after absolute). Speak only when nested sides already spoke and
    both loudnesses are > 0. ``worse`` warns only. Still ready for B.
    """
    if not (sides_bit or "").strip():
        return None, None, "", False
    if vs not in ("worse", "better"):
    ...
    bit = (
        ...
        f"louder {_fmt_share_pct(loud_pct)} · quieter {_fmt_share_pct(quiet_pct)}"
    )
    return loud_pct, quiet_pct, bit, vs == "worse"


def _exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_lead_size_sides_share_vs_delta_align_lead_size_sides_share_delta(
    share_bit: str,
    vs: str,
    louder_pct: float | None,
    quieter_pct: float | None,
) -> tuple[str, float | None, str, bool]:
    """Additive louder% − quieter% when nested align lead size sides share spoke.

    Nested share speaks ownership %. Δ speaks the pp spread so near-even
    ownership stays quiet while a lopsided pair speaks (portfolio AI +
    xang1234 after nested share). Speak only when nested share already
    spoke and both % known. wide |Δ| ≥ ``WINDOW_A_EXIT_CONC_SKEW_PP``.
    thin |Δ| < ``WINDOW_A_SHARE_DELTA_THIN_PP``. Mid stays silent.
    Near-zero stays silent. ``worse`` warns only. Still ready for B.
    """
    if not (share_bit or "").strip():
        return "", None, "", False
...
def _exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_lead_size_sides_share_vs_delta_align_lead_size_sides_share_vs_delta(
    sides_delta: str,
    share_delta: str,
    vs: str,
) -> tuple[str, str, bool]:
    """Speak when nested louder−quieter floor-unit Δ and ownership Δ disagree.
...
def _exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_lead_size_sides_share_vs_delta_align_lead_size_sides_share_vs_delta_align(
    sides_delta: str,
    share_delta: str,
    vs: str,
) -> tuple[str, str, bool]:
    """Speak when nested louder−quieter floor-unit Δ and ownership Δ agree.
...
def window_a_sample_readiness(
    ...
    *,
    ...
    empty = {
        ...
        "closes_exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_lead_size_sides_share_vs_delta_align_lead_size": "",
        "closes_exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_lead_size_sides_share_vs_delta_align_lead_size_ratio": None,
        ...
        "closes_exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_lead_size_sides_share_vs_delta_align_lead_size_sides_louder": None,
        "closes_exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_lead_size_sides_share_vs_delta_align_lead_size_sides_quieter": None,
        ...
        "closes_exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_lead_size_sides_share_vs_delta_align_lead_size_sides_delta": "",
        "closes_exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_lead_size_sides_share_vs_delta_align_lead_size_sides_delta_ratio": None,
        ...
        "closes_exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_lead_size_sides_share_vs_delta_align_lead_size_sides_share_louder_pct": None,
        "closes_exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_lead_size_sides_share_vs_delta_align_lead_size_sides_share_quieter_pct": None,
        ...
        "closes_exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_lead_size_sides_share_vs_delta_align_lead_size_sides_share_delta": "",
        "closes_exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_lead_size_sides_share_vs_delta_align_lead_size_sides_share_delta_ratio": None,
        ...
        "closes_exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_lead_size_sides_share_vs_delta_align_lead_size_sides_share_vs_delta": "",
        "closes_exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_lead_size_sides_share_vs_delta_align_lead_size_sides_share_vs_delta_bit": "",
        ...
        "closes_exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_lead_size_sides_share_vs_delta_align_lead_size_sides_share_vs_delta_align": "",
        "closes_exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_lead_size_sides_share_vs_delta_align_lead_size_sides_share_vs_delta_align_bit": "",
                        ...
                        if None not in raws:
                            ...
                            if euros is not None:
                                ...
                                (
                                    ...
                                    closes_exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_size_bit,
                                    closes_exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_size_warn,
                                ) = _exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_size(
                                    closes_exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align,
                                    closes_exit_euro_size_sign_clash_keep_fees_vs,
                                    closes_exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_delta_ratio,
                                    closes_exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_delta_ratio,
                                ...
                                (
                                    ...
                                    closes_exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_lead_bit,
                                    closes_exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_lead_warn,
                                ) = _exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_lead(
                                    closes_exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_size,
                                    closes_exit_euro_size_sign_clash_keep_fees_vs,
                                    closes_exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_delta_ratio,
                                    closes_exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_delta_ratio,
                                ...
                                (
                                    ...
                                    closes_exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_lead_size_bit,
                                    closes_exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_lead_size_warn,
                                ) = _exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_lead_size(
                                    closes_exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_lead,
                                    closes_exit_euro_size_sign_clash_keep_fees_vs,
                                    closes_exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_delta_ratio,
                                    closes_exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_delta_ratio,
                                ...
                                (
                                    ...
                                    closes_exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_lead_size_sides_bit,
                                    closes_exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_lead_size_sides_warn,
                                ) = _exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_lead_size_sides(
                                    closes_exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_lead_size,
                                    closes_exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_lead,
                                    closes_exit_euro_size_sign_clash_keep_fees_vs,
                                    closes_exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_delta_ratio,
                                ...
                                (
                                    ...
                                    closes_exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_lead_size_sides_delta_bit,
                                    closes_exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_lead_size_sides_delta_warn,
                                ) = _exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_lead_size_sides_delta(
                                    closes_exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_lead_size_sides_bit,
                                    closes_exit_euro_size_sign_clash_keep_fees_vs,
                                    closes_exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_lead_size_sides_louder,
                                    closes_exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_lead_size_sides_quieter,
                                ...
                                (
                                    ...
                                    closes_exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_lead_size_sides_share_bit,
                                    closes_exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_lead_size_sides_share_warn,
                                ) = _exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_lead_size_sides_share(
                                    closes_exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_lead_size_sides_bit,
                                    closes_exit_euro_size_sign_clash_keep_fees_vs,
                                    closes_exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_lead_size_sides_louder,
                                    closes_exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_lead_size_sides_quieter,
                                ...
                                (
                                    ...
                                    closes_exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_lead_size_sides_share_delta_bit,
                                    closes_exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_lead_size_sides_share_delta_warn,
                                ) = _exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_lead_size_sides_share_delta(
                                    closes_exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_lead_size_sides_share_bit,
                                    closes_exit_euro_size_sign_clash_keep_fees_vs,
                                    closes_exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_lead_size_sides_share_louder_pct,
                                    closes_exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_lead_size_sides_share_quieter_pct,
                                ...
                                (
                                    ...
                                    closes_exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_lead_size_sides_share_vs_delta_bit,
                                    closes_exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_lead_size_sides_share_vs_delta_warn,
                                ) = _exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_lead_size_sides_share_vs_delta(
                                    closes_exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_lead_size_sides_delta,
                                    closes_exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_lead_size_sides_share_delta,
                                    closes_exit_euro_size_sign_clash_keep_fees_vs,
                                )
                                (
                                    ...
                                    closes_exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_lead_size_sides_share_vs_delta_align_bit,
                                    closes_exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_lead_size_sides_share_vs_delta_align_warn,
                                ) = _exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_lead_size_sides_share_vs_delta_align(
                                    closes_exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_lead_size_sides_delta,
                                    closes_exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_lead_size_sides_share_delta,
                                    closes_exit_euro_size_sign_clash_keep_fees_vs,
                                )
                                (
                                    ...
                                    closes_exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_lead_size_sides_share_vs_delta_align_size_bit,
                                    closes_exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_lead_size_sides_share_vs_delta_align_size_warn,
                                ) = _exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_lead_size_sides_share_vs_delta_align_size(
                                    closes_exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_lead_size_sides_share_vs_delta_align,
                                    closes_exit_euro_size_sign_clash_keep_fees_vs,
                                    closes_exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_lead_size_sides_delta_ratio,
                                    closes_exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_lead_size_sides_share_delta_ratio,
                                ...
                                (
                                    ...
                                    closes_exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_lead_size_sides_share_vs_delta_align_lead_size_bit,
                                    closes_exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_lead_size_sides_share_vs_delta_align_lead_size_warn,
                                ) = _exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_lead_size_sides_share_vs_delta_align_lead_size(
                                    closes_exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_lead_size_sides_share_vs_delta_align_lead,
                                    closes_exit_euro_size_sign_clash_keep_fees_vs,
                                    closes_exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_lead_size_sides_delta_ratio,
                                    closes_exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_lead_size_sides_share_delta_ratio,
                                ...
                                (
                                    ...
                                    closes_exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_lead_size_sides_share_vs_delta_align_lead_size_sides_bit,
                                    closes_exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_lead_size_sides_share_vs_delta_align_lead_size_sides_warn,
                                ) = _exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_lead_size_sides_share_vs_delta_align_lead_size_sides(
                                    closes_exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_lead_size_sides_share_vs_delta_align_lead_size,
                                    closes_exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_lead_size_sides_share_vs_delta_align_lead,
                                    closes_exit_euro_size_sign_clash_keep_fees_vs,
                                    closes_exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_lead_size_sides_delta_ratio,
                                ...
                                (
                                    ...
                                    closes_exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_lead_size_sides_share_vs_delta_align_lead_size_sides_delta_bit,
                                    closes_exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_lead_size_sides_share_vs_delta_align_lead_size_sides_delta_warn,
                                ) = _exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_lead_size_sides_share_vs_delta_align_lead_size_sides_delta(
                                    closes_exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_lead_size_sides_share_vs_delta_align_lead_size_sides_bit,
                                    closes_exit_euro_size_sign_clash_keep_fees_vs,
                                    closes_exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_lead_size_sides_share_vs_delta_align_lead_size_sides_louder,
                                    closes_exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_lead_size_sides_share_vs_delta_align_lead_size_sides_quieter,
                                ...
                                (
                                    ...
                                    closes_exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_lead_size_sides_share_vs_delta_align_lead_size_sides_share_bit,
                                    closes_exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_lead_size_sides_share_vs_delta_align_lead_size_sides_share_warn,
                                ) = _exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_lead_size_sides_share_vs_delta_align_lead_size_sides_share(
                                    closes_exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_lead_size_sides_share_vs_delta_align_lead_size_sides_bit,
                                    closes_exit_euro_size_sign_clash_keep_fees_vs,
                                    closes_exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_lead_size_sides_share_vs_delta_align_lead_size_sides_louder,
                                    closes_exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_lead_size_sides_share_vs_delta_align_lead_size_sides_quieter,
                                ...
                                (
                                    ...
                                    closes_exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_lead_size_sides_share_vs_delta_align_lead_size_sides_share_delta_bit,
                                    closes_exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_lead_size_sides_share_vs_delta_align_lead_size_sides_share_delta_warn,
                                ) = _exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_lead_size_sides_share_vs_delta_align_lead_size_sides_share_delta(
                                    closes_exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_lead_size_sides_share_vs_delta_align_lead_size_sides_share_bit,
                                    closes_exit_euro_size_sign_clash_keep_fees_vs,
                                    closes_exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_lead_size_sides_share_vs_delta_align_lead_size_sides_share_louder_pct,
                                    closes_exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_lead_size_sides_share_vs_delta_align_lead_size_sides_share_quieter_pct,
                                ...
                                (
                                    ...
                                    closes_exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_lead_size_sides_share_vs_delta_align_lead_size_sides_share_vs_delta_bit,
                                    closes_exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_lead_size_sides_share_vs_delta_align_lead_size_sides_share_vs_delta_warn,
                                ) = _exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_lead_size_sides_share_vs_delta_align_lead_size_sides_share_vs_delta(
                                    closes_exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_lead_size_sides_share_vs_delta_align_lead_size_sides_delta,
                                    closes_exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_lead_size_sides_share_vs_delta_align_lead_size_sides_share_delta,
                                    closes_exit_euro_size_sign_clash_keep_fees_vs,
                                )
                                (
                                    ...
                                    closes_exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_lead_size_sides_share_vs_delta_align_lead_size_sides_share_vs_delta_align_bit,
                                    closes_exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_lead_size_sides_share_vs_delta_align_lead_size_sides_share_vs_delta_align_warn,
                                ) = _exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_lead_size_sides_share_vs_delta_align_lead_size_sides_share_vs_delta_align(
                                    closes_exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_lead_size_sides_share_vs_delta_align_lead_size_sides_delta,
                                    closes_exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_lead_size_sides_share_vs_delta_align_lead_size_sides_share_delta,
                                    closes_exit_euro_size_sign_clash_keep_fees_vs,
                                )
...
def format_window_a_closes_exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_size_bit(
    sample: dict[str, Any] | None,
) -> str:
    """Short Window A align × and pp size bit (display only)."""
    if not isinstance(sample, dict):
        return ""
    bit = str(
        sample.get(
...
def format_window_a_closes_exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_lead_bit(
    sample: dict[str, Any] | None,
) -> str:
    """Short Window A align lead bit (display only)."""
    if not isinstance(sample, dict):
        return ""
    bit = str(
        sample.get(
...
def format_window_a_closes_exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_lead_size_bit(
    sample: dict[str, Any] | None,
) -> str:
    """Short Window A align lead size bit (display only)."""
    if not isinstance(sample, dict):
        return ""
    bit = str(
        sample.get(
...
def format_window_a_closes_exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_lead_size_sides_bit(
    sample: dict[str, Any] | None,
) -> str:
    """Short Window A align lead size sides bit (display only)."""
    if not isinstance(sample, dict):
        return ""
    bit = str(
        sample.get(
...
def format_window_a_closes_exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_lead_size_sides_delta_bit(
    sample: dict[str, Any] | None,
) -> str:
    """Short Window A align lead size sides Δ bit (display only)."""
    if not isinstance(sample, dict):
        return ""
    bit = str(
        sample.get(
...
def format_window_a_closes_exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_lead_size_sides_share_bit(
    sample: dict[str, Any] | None,
) -> str:
    """Short Window A align lead size sides share bit (display only)."""
    if not isinstance(sample, dict):
        return ""
    bit = str(
        sample.get(
...
def format_window_a_closes_exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_lead_size_sides_share_delta_bit(
    sample: dict[str, Any] | None,
) -> str:
    """Short Window A align lead size sides share Δ bit (display only)."""
    if not isinstance(sample, dict):
        return ""
    bit = str(
        sample.get(
...
def format_window_a_closes_exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_lead_size_sides_share_vs_delta_bit(
    sample: dict[str, Any] | None,
) -> str:
    """Short Window A align lead size sides share vs Δ clash bit (display only)."""
    if not isinstance(sample, dict):
        return ""
    bit = str(
        sample.get(
...
def format_window_a_closes_exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_lead_size_sides_share_vs_delta_align_bit(
    sample: dict[str, Any] | None,
) -> str:
    """Short Window A align lead size sides share vs Δ align bit (display only)."""
    if not isinstance(sample, dict):
        return ""
    bit = str(
        sample.get(
...
def format_window_a_closes_exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_lead_size_sides_share_vs_delta_align_size_bit(
    sample: dict[str, Any] | None,
) -> str:
    """Short Window A nested align size bit (display only)."""
    if not isinstance(sample, dict):
        return ""
    bit = str(
        sample.get(
...
def format_window_a_closes_exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_lead_size_sides_share_vs_delta_align_lead_size_bit(
    sample: dict[str, Any] | None,
) -> str:
    """Short Window A nested align lead size bit (display only)."""
    if not isinstance(sample, dict):
        return ""
    bit = str(
        sample.get(
...
def format_window_a_closes_exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_lead_size_sides_share_vs_delta_align_lead_size_sides_bit(
    sample: dict[str, Any] | None,
) -> str:
    """Short Window A nested align lead size sides bit (display only)."""
    if not isinstance(sample, dict):
        return ""
    bit = str(
        sample.get(
...
def format_window_a_closes_exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_lead_size_sides_share_vs_delta_align_lead_size_sides_delta_bit(
    sample: dict[str, Any] | None,
) -> str:
    """Short Window A nested align lead size sides Δ bit (display only)."""
    if not isinstance(sample, dict):
        return ""
    bit = str(
        sample.get(
...
def format_window_a_closes_exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_lead_size_sides_share_vs_delta_align_lead_size_sides_share_bit(
    sample: dict[str, Any] | None,
) -> str:
    """Short Window A nested align lead size sides share bit (display only)."""
    if not isinstance(sample, dict):
        return ""
    bit = str(
        sample.get(
...
def format_window_a_closes_exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_lead_size_sides_share_vs_delta_align_lead_size_sides_share_delta_bit(
    sample: dict[str, Any] | None,
) -> str:
    """Short Window A nested align lead size sides share Δ bit (display only)."""
    if not isinstance(sample, dict):
        return ""
    bit = str(
        sample.get(
...
def format_window_a_closes_exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_lead_size_sides_share_vs_delta_align_lead_size_sides_share_vs_delta_bit(
    sample: dict[str, Any] | None,
) -> str:
    """Short Window A nested align lead size sides share vs Δ clash bit (display only)."""
    if not isinstance(sample, dict):
        return ""
    bit = str(
        sample.get(
...
def format_window_a_closes_exit_euro_size_sign_clash_keep_fees_vs_gap_dir_sides_share_vs_delta_align_lead_size_sides_share_vs_delta_align_lead_size_sides_share_vs_delta_align_bit(
    sample: dict[str, Any] | None,
) -> str:
    """Short Window A nested align lead size sides share vs Δ align bit (display only)."""
    if not isinstance(sample, dict):
        return ""
    bit = str(
        sample.get(
