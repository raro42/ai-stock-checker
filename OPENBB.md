...
- **Earnings blackout:** no new stock entries within 2d before / 1d after earnings (`earnings_guard.py`); empty Yahoo `earnings_dates` window → allow (suspect fail-open); missing calendar date → allow (fail-open)
